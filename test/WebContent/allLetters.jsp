...
<title>All Letters Page</title>
</head>
<body>
<h1>Stories from Everybody</h1>
...
<a href=<%=request.getContextPath()%>/profile/${letterObject.letterUser}>${letterObject.letterUser}</a>
    Says "<c:out value="${letterObject.letterContent}"></c:out>"
    
    At <c:out value="${letterObject.timeDate}"></c:out> </p> </div>
</c:forEach>
</body>
</html>